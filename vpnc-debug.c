...
const struct debug_strings isakmp_modecfg_attrib_enum_array[] = {
	...
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_TYPE,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_TYPE)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_USER_NAME,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_USER_NAME)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_USER_PASSWORD,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_USER_PASSWORD)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_PASSCODE,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_PASSCODE)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_MESSAGE,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_MESSAGE)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_CHALLENGE,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_CHALLENGE)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_DOMAIN,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_DOMAIN)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_STATUS,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_STATUS)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_NEXT_PIN,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_NEXT_PIN)" },
	{ ISAKMP_XAUTH_ATTRIB_NORTEL_ANSWER,	" (ISAKMP_XAUTH_ATTRIB_NORTEL_ANSWER)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_TYPE,	" (ISAKMP_XAUTH_ATTRIB_RFC_TYPE)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_USER_NAME,	" (ISAKMP_XAUTH_ATTRIB_RFC_USER_NAME)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_USER_PASSWORD,	" (ISAKMP_XAUTH_ATTRIB_RFC_USER_PASSWORD)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_PASSCODE,	" (ISAKMP_XAUTH_ATTRIB_RFC_PASSCODE)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_MESSAGE,	" (ISAKMP_XAUTH_ATTRIB_RFC_MESSAGE)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_CHALLENGE,	" (ISAKMP_XAUTH_ATTRIB_RFC_CHALLENGE)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_DOMAIN,	" (ISAKMP_XAUTH_ATTRIB_RFC_DOMAIN)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_STATUS,	" (ISAKMP_XAUTH_ATTRIB_RFC_STATUS)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_NEXT_PIN,	" (ISAKMP_XAUTH_ATTRIB_RFC_NEXT_PIN)" },
	{ ISAKMP_XAUTH_ATTRIB_RFC_ANSWER,	" (ISAKMP_XAUTH_ATTRIB_RFC_ANSWER)" },
